...
import weka_predictions.classifiers.misc.InputMappedClassifier;
...
import weka_predictions.filters.unsupervised.attribute.Reorder;
import weka_predictions.filters.unsupervised.attribute.SwapValues;
...
public class InputMappedClassifierTest extends AbstractClassifierTest {
  ...
  public Classifier getClassifier() {
    ...
    toUse.setClassifier(new weka_predictions.classifiers.trees.J48());
...
/*  public void testNominalClassDifferingNumClassValues() {
  ...
  protected InputMappedClassifier trainClassifier(Instances data, boolean nominalClass) {
    ...
    if (nominalClass) {
      ...
      toUse.setClassifier(new weka_predictions.classifiers.functions.LinearRegression());
    }
    toUse.setSuppressMappingReport(true);
