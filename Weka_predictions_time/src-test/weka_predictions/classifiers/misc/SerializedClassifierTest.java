...
import weka_predictions.classifiers.misc.SerializedClassifier;
...
public class SerializedClassifierTest
  ...
  protected double[] trainAndSerializeClassifier(Instances data) {
	...
	classifier = new weka_predictions.classifiers.trees.J48();
      else
	classifier = new weka_predictions.classifiers.trees.M5P();
