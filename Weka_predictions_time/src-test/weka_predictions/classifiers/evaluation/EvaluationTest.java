...
import weka_predictions.classifiers.evaluation.Evaluation;
...
public class EvaluationTest extends TestCase {
  ...
  public void testRegression() throws Exception {
    ...
    weka_predictions.test.Regression reg = new weka_predictions.test.Regression(getClass());
  ...
  public static Test suite() {
    return new TestSuite(weka_predictions.classifiers.evaluation.EvaluationTest.class);
  }
