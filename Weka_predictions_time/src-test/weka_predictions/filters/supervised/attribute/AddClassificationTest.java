...
import weka_predictions.filters.supervised.attribute.AddClassification;
...
public class AddClassificationTest 
  ...
  protected void performTest(boolean num, boolean cl, boolean dist, boolean error, boolean remove) {
    ...
    m_Filter = getFilter();
    if (num)
      ((AddClassification) m_Filter).setClassifier(new weka_predictions.classifiers.trees.M5P());
    else
      ((AddClassification) m_Filter).setClassifier(new weka_predictions.classifiers.trees.J48());
