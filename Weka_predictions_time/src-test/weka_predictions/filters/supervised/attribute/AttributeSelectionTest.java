...
import weka_predictions.filters.supervised.attribute.AttributeSelection;
...
public class AttributeSelectionTest extends AbstractFilterTest {
  ...
  public void testPrincipalComponent() {
    m_Filter = getFilter(new weka_predictions.attributeSelection.PrincipalComponents(), 
                         new weka_predictions.attributeSelection.Ranker());
