...
import weka_predictions.filters.unsupervised.instance.RemoveMisclassified;
...
public class RemoveMisclassifiedTest 
  ...
  protected Filter getFilter(boolean nominal) {
    ...
    // classifier
    if (nominal)
      f.setClassifier(new weka_predictions.classifiers.trees.J48());
    else
      f.setClassifier(new weka_predictions.classifiers.trees.M5P());
