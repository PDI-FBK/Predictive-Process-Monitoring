...
import weka_predictions.attributeSelection.BestFirst;
import weka_predictions.attributeSelection.SubsetEvaluator;
import weka_predictions.classifiers.AbstractClassifier;
import weka_predictions.classifiers.Evaluation;
import weka_predictions.classifiers.lazy.IBk;
import weka_predictions.core.AdditionalMeasureProducer;
...
//	if (ok) {
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (searchString.length() == 0)
      searchString = weka_predictions.attributeSelection.BestFirst.class.getName();
  ...
  public void buildClassifier(Instances data) throws Exception {
    ...
    if (m_theInstances.classAttribute().isNumeric()) {
      m_disTransform = new weka_predictions.filters.unsupervised.attribute.Discretize();
      m_classIsNominal = false;

      // use binned discretisation if the class is numeric
      ((weka_predictions.filters.unsupervised.attribute.Discretize)m_disTransform).
      setBins(10);
      ((weka_predictions.filters.unsupervised.attribute.Discretize)m_disTransform).
      ...
      m_disTransform = new weka_predictions.filters.supervised.attribute.Discretize();
      ((weka_predictions.filters.supervised.attribute.Discretize)m_disTransform).setUseBetterEncoding(true);
