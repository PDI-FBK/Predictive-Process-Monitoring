 ...
 *
 */
package weka_predictions.classifiers.bayes.net;
...
import weka_predictions.classifiers.bayes.net.MarginCalculator.JunctionTreeNode;
...
import weka_predictions.gui.graphvisualizer.BIFParser;
import weka_predictions.gui.graphvisualizer.GraphNode;
import weka_predictions.gui.graphvisualizer.HierarchicalBCEngine;
import weka_predictions.gui.graphvisualizer.LayoutCompleteEvent;
import weka_predictions.gui.graphvisualizer.LayoutCompleteEventListener;
import weka_predictions.gui.graphvisualizer.LayoutEngine;
				...
				jBtOptions.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent ae) {
						...
						try {
							...
							ce.setClassType(weka_predictions.classifiers.Classifier.class);
