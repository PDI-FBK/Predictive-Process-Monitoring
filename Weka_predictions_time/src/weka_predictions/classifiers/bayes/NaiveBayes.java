...
import weka_predictions.core.Aggregateable;
...
import weka_predictions.estimators.DiscreteEstimator;
import weka_predictions.estimators.Estimator;
import weka_predictions.estimators.KernelEstimator;
import weka_predictions.estimators.NormalEstimator;
...
implements OptionHandler, WeightedInstancesHandler, 
   ...
   */
  protected weka_predictions.filters.supervised.attribute.Discretize m_Disc = null;
  ...
  public void buildClassifier(Instances instances) throws Exception {
    ...
    if (m_UseDiscretization) {
      m_Disc = new weka_predictions.filters.supervised.attribute.Discretize();
      m_Disc.setInputFormat(m_Instances);
      m_Instances = weka_predictions.filters.Filter.useFilter(m_Instances, m_Disc);
    } else {
      m_Disc = null;
    }
