...
package weka_predictions.classifiers;
...
public class Evaluation implements Serializable, Summarizable, RevisionHandler {
  ...
  public static final String[] BUILT_IN_EVAL_METRICS = weka_predictions.classifiers.evaluation.Evaluation.BUILT_IN_EVAL_METRICS;

  /** The actual evaluation object that we delegate to */
  protected weka_predictions.classifiers.evaluation.Evaluation m_delegate;
  ...
  public static List<String> getAllEvaluationMetricNames() {
    return weka_predictions.classifiers.evaluation.Evaluation.getAllEvaluationMetricNames();
  }

  public Evaluation(Instances data) throws Exception {
    m_delegate = new weka_predictions.classifiers.evaluation.Evaluation(data);
  }

  public Evaluation(Instances data, CostMatrix costMatrix) throws Exception {
    m_delegate = new weka_predictions.classifiers.evaluation.Evaluation(data, costMatrix);
  }
  ...
  public static String evaluateModel(String classifierString, String[] options)
    ...
    return weka_predictions.classifiers.evaluation.Evaluation.evaluateModel(
  ...
  public static String evaluateModel(Classifier classifier, String[] options)
      throws Exception {
    return weka_predictions.classifiers.evaluation.Evaluation.evaluateModel(classifier,
        options);
  }
  ...
  public static String wekaStaticWrapper(Sourcable classifier, String className)
      throws Exception {
    return weka_predictions.classifiers.evaluation.Evaluation.wekaStaticWrapper(classifier,
        className);
  }
  ...
  public boolean equals(Object obj) {
    if (obj instanceof weka_predictions.classifiers.Evaluation) {
      obj = ((weka_predictions.classifiers.Evaluation) obj).m_delegate;
    }
