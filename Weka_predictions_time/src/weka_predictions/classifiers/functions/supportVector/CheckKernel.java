...
public class CheckKernel
  ...
  protected Kernel m_Kernel = new weka_predictions.classifiers.functions.supportVector.RBFKernel();
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (tmpStr.length() == 0)
      tmpStr = weka_predictions.classifiers.functions.supportVector.RBFKernel.class.getName();
    setKernel(
	(Kernel) forName(
