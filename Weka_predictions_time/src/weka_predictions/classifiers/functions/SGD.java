  ...
  public void buildClassifier(Instances data) throws Exception {
    ...
    if (!onlyNumeric) {
      if (data.numInstances() > 0) {
        m_nominalToBinary = new weka_predictions.filters.supervised.attribute.NominalToBinary();
      } else {
        m_nominalToBinary = new weka_predictions.filters.unsupervised.attribute.NominalToBinary();
      }
