...
package weka_predictions.classifiers.lazy;
...
import weka_predictions.core.neighboursearch.LinearNNSearch;
...
public class IBk 
  ...
  protected void crossValidate() {
    ...
    try {
      if (m_NNSearch instanceof weka_predictions.core.neighboursearch.CoverTree)
