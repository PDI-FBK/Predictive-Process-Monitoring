...
public class CheckClassifier
  ...
  protected Classifier m_Classifier = new weka_predictions.classifiers.rules.ZeroR();
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (tmpStr.length() == 0)
      tmpStr = weka_predictions.classifiers.rules.ZeroR.class.getName();
    setClassifier(
        (Classifier) forName(
          "weka.classifiers",
          Classifier.class,
  ...
  throws Exception {
    ...
    try {
      ...
      Classifier zeroR = new weka_predictions.classifiers.rules.ZeroR();
