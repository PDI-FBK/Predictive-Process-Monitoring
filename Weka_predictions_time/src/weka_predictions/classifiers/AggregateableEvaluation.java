...
public class AggregateableEvaluation extends Evaluation {
  ...
  public AggregateableEvaluation(Instances data) throws Exception {
    super(data);
    m_delegate = new weka_predictions.classifiers.evaluation.AggregateableEvaluation(data);
  }
  ...
  public AggregateableEvaluation(Evaluation eval) throws Exception {
    ...
    m_delegate = new weka_predictions.classifiers.evaluation.AggregateableEvaluation(
        eval.m_delegate);
  }
  ...
  public void aggregate(Evaluation evaluation) {
    ((weka_predictions.classifiers.evaluation.AggregateableEvaluation) m_delegate)
