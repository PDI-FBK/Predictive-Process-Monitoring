...
package weka_predictions.classifiers.evaluation.output.prediction;
...
import weka_predictions.core.WekaException;
...
public abstract class AbstractOutput implements Serializable, OptionHandler {
  ...
  protected Instance preProcessInstance(Instance inst, Instance withMissing,
    ...
    if (classifier instanceof weka_predictions.classifiers.misc.InputMappedClassifier) {
      ...
      inst = ((weka_predictions.classifiers.misc.InputMappedClassifier) classifier)
