...
public class AttributeSelectedClassifier 
  ...
  protected ASEvaluation m_Evaluator = 
    new weka_predictions.attributeSelection.CfsSubsetEval();

  /** The search method to use */
  protected ASSearch m_Search = new weka_predictions.attributeSelection.BestFirst();
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (evaluatorString.length() == 0)
      evaluatorString = weka_predictions.attributeSelection.CfsSubsetEval.class.getName();
