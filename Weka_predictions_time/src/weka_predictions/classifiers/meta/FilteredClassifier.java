...
public class FilteredClassifier 
  ...
  /** The filter */
  protected Filter m_Filter = new weka_predictions.filters.supervised.attribute.AttributeSelection();
  ...
  public FilteredClassifier() {
    ...
    m_Filter = new weka_predictions.filters.supervised.attribute.Discretize();
  }
  ...
  public void setOptions(String[] options) throws Exception {
	...
	throw new IllegalArgumentException("Invalid filter specification string");
      ...
      setFilter(new weka_predictions.filters.supervised.attribute.Discretize());
    }
