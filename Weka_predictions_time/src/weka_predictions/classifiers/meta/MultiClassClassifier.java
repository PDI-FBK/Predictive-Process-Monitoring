...
import weka_predictions.filters.unsupervised.attribute.MakeIndicator;
import weka_predictions.filters.unsupervised.instance.RemoveWithValues;
...
public class MultiClassClassifier 
  ...
  public MultiClassClassifier() {
    ...
    m_Classifier = new weka_predictions.classifiers.functions.Logistic();
  }
