...
package weka_predictions.core.pmml;
...
import weka_predictions.classifiers.pmml.consumer.GeneralRegression;
import weka_predictions.classifiers.pmml.consumer.NeuralNetwork;
import weka_predictions.classifiers.pmml.consumer.PMMLClassifier;
import weka_predictions.classifiers.pmml.consumer.Regression;
import weka_predictions.classifiers.pmml.consumer.RuleSetModel;
import weka_predictions.classifiers.pmml.consumer.SupportVectorMachineModel;
import weka_predictions.classifiers.pmml.consumer.TreeModel;
...
public class PMMLFactory {
  ...
  private static class PMMLClassifierRunner extends AbstractClassifier {
    ...
    public String getRevision() {
      return weka_predictions.core.RevisionUtils.extract("$Revision: 8034 $");
    }
