...
import weka_predictions.core.converters.ArffLoader.ArffReader;
...
public class Instances extends AbstractList<Instance>
  ...
  */
   ...
   * @see weka_predictions.core.converters.ArffLoader
   * @see weka_predictions.core.converters.ConverterUtils.DataSource
   */
  //@ requires capacity >= 0;
  ...
  public AttributeStats attributeStats(int index) {
    ...
    if (attribute(index).isNumeric()) {
      result.numericStats = new weka_predictions.experiment.Stats();
    }
