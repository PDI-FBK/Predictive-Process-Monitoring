...
import weka_predictions.core.ClassDiscovery;
...
public class ConverterUtils
  ...
  public final static String CORE_FILE_LOADERS = 
      weka_predictions.core.converters.ArffLoader.class.getName() + ","
    //    + weka.core.converters.C45Loader.class.getName() + ","
    + weka_predictions.core.converters.CSVLoader.class.getName() + ","
    + weka_predictions.core.converters.DatabaseConverter.class.getName() + ","
    ...
    + weka_predictions.core.converters.SerializedInstancesLoader.class.getName() + ","
    + weka_predictions.core.converters.TextDirectoryLoader.class.getName() + ","
    + weka_predictions.core.converters.XRFFLoader.class.getName();

  /** the core savers - hardcoded list necessary for RMI/Remote Experiments 
   * (comma-separated list). */
  public final static String CORE_FILE_SAVERS =
      weka_predictions.core.converters.ArffSaver.class.getName() + ","
    //    + weka.core.converters.C45Saver.class.getName() + ","
    + weka_predictions.core.converters.CSVSaver.class.getName() + ","
    + weka_predictions.core.converters.DatabaseConverter.class.getName() + ","
    ...
    + weka_predictions.core.converters.SerializedInstancesSaver.class.getName() + ","
    + weka_predictions.core.converters.XRFFSaver.class.getName();
  ...
  public static void initialize() {
    ...
    weka_predictions.gui.ConverterFileChooser.initDefaultFilters();
  }
