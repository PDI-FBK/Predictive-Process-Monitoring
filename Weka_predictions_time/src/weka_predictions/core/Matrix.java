...
public class Matrix 
  ...
  /**
   * The actual matrix */
  protected weka_predictions.core.matrix.Matrix m_Matrix = null;
  ...
  public Matrix(int nr, int nc) {
    m_Matrix = new weka_predictions.core.matrix.Matrix(nr, nc);
  }
  ...
  public Matrix(double[][] array) throws Exception {
    m_Matrix = new weka_predictions.core.matrix.Matrix(array);
  }
  ...
  public Matrix(Reader r) throws Exception {
    m_Matrix = new weka_predictions.core.matrix.Matrix(r);
  }
   ...
   * @see #m_Matrix
   */
  protected weka_predictions.core.matrix.Matrix getMatrix() {
    return m_Matrix;
  }
  ...
  public int[] LUDecomposition() throws Exception {
    // decompose
    weka_predictions.core.matrix.LUDecomposition lu = m_Matrix.lu();

    // singular? old class throws Exception!
    if (!lu.isNonsingular())
    	throw new Exception("Matrix is singular");

    weka_predictions.core.matrix.Matrix u = lu.getU();
    weka_predictions.core.matrix.Matrix l = lu.getL();
  ...
  public void solve(double[] bb) throws Exception {
    // solve
    weka_predictions.core.matrix.Matrix x = m_Matrix.solve(
                                    new weka_predictions.core.matrix.Matrix(bb, bb.length));
  ...
  public void eigenvalueDecomposition(double[][] V, double[] d) 
    ...
    weka_predictions.core.matrix.EigenvalueDecomposition eig = m_Matrix.eig();
    weka_predictions.core.matrix.Matrix v = eig.getV();
  ...
  protected static double hypot(double a, double b) {
    return weka_predictions.core.matrix.Maths.hypot(a, b);
  }
  ...
  public static Matrix parseMatlab(String matlab) throws Exception {
    return new Matrix(weka_predictions.core.matrix.Matrix.parseMatlab(matlab).getArray());
  }
