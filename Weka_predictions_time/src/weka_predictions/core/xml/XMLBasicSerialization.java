...
package weka_predictions.core.xml;
...
public class XMLBasicSerialization
   ...
   public void clear() throws Exception {
      ...
      // Weka classes
      m_CustomMethods.register(this, weka_predictions.core.matrix.Matrix.class, "Matrix");
      m_CustomMethods.register(this, weka_predictions.core.Matrix.class, "MatrixOld");
      m_CustomMethods.register(this, weka_predictions.classifiers.CostMatrix.class, "CostMatrixOld");
   }
    ...
    * @return the node that was created
    * @throws Exception if the DOM creation fails
    * @see weka_predictions.core.matrix.Matrix
    */
   public Element writeMatrix(Element parent, Object o, String name) 
      throws Exception {

      weka_predictions.core.matrix.Matrix    matrix;
      Element                    node;
      ...
      matrix = (weka_predictions.core.matrix.Matrix) o;
      node   = addElement(parent, name, o.getClass().getName(), false);
   ...
   public Object readMatrix(Element node) throws Exception {
      ...
      for (i = 0; i < children.size(); i++) {
         ...
         if (name.equals(VAL_CELLS)) {
            ...
            matrix = new weka_predictions.core.matrix.Matrix(
                        (double[][]) o);
         }
      }
    ...
    * @return the node that was created
    * @throws Exception if the DOM creation fails
    * @see weka_predictions.core.Matrix
    */
   public Element writeMatrixOld(Element parent, Object o, String name) 
      throws Exception {

      weka_predictions.core.Matrix  matrix;
      Element           node;
      double[][]        array;
      int               i;
      ...
      matrix = (weka_predictions.core.Matrix) o;
      node   = addElement(parent, name, o.getClass().getName(), false);
   ...
   public Object readMatrixOld(Element node) throws Exception {
      weka_predictions.core.Matrix           matrix;
      weka_predictions.core.matrix.Matrix    matrixNew;
      ...
      matrixNew = (weka_predictions.core.matrix.Matrix) readMatrix(node);
      matrix    = new weka_predictions.core.Matrix(matrixNew.getArrayCopy());
    ...
    * @return the node that was created
    * @throws Exception if the DOM creation fails
    * @see weka_predictions.classifiers.CostMatrix
    */
   ...
   public Object readCostMatrixOld(Element node) throws Exception {
      weka_predictions.classifiers.CostMatrix   matrix;
      weka_predictions.core.matrix.Matrix       matrixNew;
      StringWriter                  writer;
      ...
      matrix    = new weka_predictions.classifiers.CostMatrix(new StringReader(writer.toString()));
