...
public class RemoveMisclassified 
  ...
  protected Classifier m_cleansingClassifier = new weka_predictions.classifiers.rules.ZeroR();
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (classifierString.length() == 0)
      classifierString = weka_predictions.classifiers.rules.ZeroR.class.getName();
