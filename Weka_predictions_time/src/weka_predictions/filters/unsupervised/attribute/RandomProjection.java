  ...
  public boolean setInputFormat(Instances instanceInfo) throws Exception {      
    ...
    */
	...
	if( i!=instanceInfo.classIndex() && instanceInfo.attribute(i).isNominal() ) {
            if(instanceInfo.classIndex()>=0)
                m_ntob = new weka_predictions.filters.supervised.attribute.NominalToBinary();
            else
                m_ntob = new weka_predictions.filters.unsupervised.attribute.NominalToBinary();
	...
	m_replaceMissing = new weka_predictions.filters.unsupervised.attribute.ReplaceMissingValues();
