...
import weka_predictions.clusterers.AbstractDensityBasedClusterer;
...
public class ClusterMembership 
  ...
  /** The clusterer */
  protected DensityBasedClusterer m_clusterer = new weka_predictions.clusterers.EM();
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (clustererString.length() == 0)
      clustererString = weka_predictions.clusterers.EM.class.getName();
