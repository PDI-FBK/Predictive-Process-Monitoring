...
import weka_predictions.core.SparseInstance;
...
//            return 0;
  ...
  protected ArrayList<BinaryItem> getSingletons(Object source) 
    ...
    } else if (source instanceof weka_predictions.core.converters.ArffLoader) {
      data = ((weka_predictions.core.converters.ArffLoader)source).getStructure();
    }
    ...
    if (source instanceof Instances) {
      ...
      weka_predictions.core.converters.ArffLoader loader = (weka_predictions.core.converters.ArffLoader)source;
  ...
  protected FPTreeRoot buildFPTree(ArrayList<BinaryItem> singletons,
    ...
    } else if (dataSource instanceof weka_predictions.core.converters.ArffLoader) {
      data = ((weka_predictions.core.converters.ArffLoader)dataSource).getStructure();
    }
    ...
    if (dataSource instanceof Instances) {
      ...
      weka_predictions.core.converters.ArffLoader loader = 
        (weka_predictions.core.converters.ArffLoader)dataSource;
      Instance current = null;
      int count = 0;
      while ((current = loader.getNextInstance(data)) != null) {
...
//    m_minSupport = -1;
  ...
  private void buildAssociations(Object source) throws Exception {
    ...
    if (source instanceof weka_predictions.core.converters.ArffLoader) {
      data = ((weka_predictions.core.converters.ArffLoader)source).getStructure();
    ...
    do {
      if (arffLoader) {
        ((weka_predictions.core.converters.ArffLoader)source).reset();
      }
  ...
  public static void main(String[] args) {
    try {
      ...
      if (!Utils.getFlag("disk", args)) {
        ...
        weka_predictions.core.converters.ArffLoader loader = null;
        if (filename.length() != 0) {
          loader = new weka_predictions.core.converters.ArffLoader();
