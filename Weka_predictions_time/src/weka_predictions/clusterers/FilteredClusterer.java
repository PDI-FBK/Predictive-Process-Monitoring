 ...
 * @see weka_predictions.classifiers.meta.FilteredClassifier
 */
public class FilteredClusterer
  ...
  public FilteredClusterer() {
    ...
    m_Filter    = new weka_predictions.filters.AllFilter();
  }
  ...
  protected String defaultFilterString() {
    return weka_predictions.filters.AllFilter.class.getName();
  }
  ...
  public void setOptions(String[] options) throws Exception {
	...
	throw new IllegalArgumentException("Invalid filter specification string");
      ...
      setFilter(new weka_predictions.filters.AllFilter());
    }
