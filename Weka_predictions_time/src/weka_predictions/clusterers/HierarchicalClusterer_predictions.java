...
*/
public class HierarchicalClusterer_predictions extends AbstractClusterer implements OptionHandler, CapabilitiesHandler, Drawable {
  ...
  public static void main(String [] argv) {
    runClusterer(new HierarchicalClusterer_predictions(), argv);
  }
  @Override
