...
import weka_predictions.associations.AssociationRules;
...
import weka_predictions.gui.visualize.plugins.AssociationRuleVisualizePlugin;
        ...
        public void run() {
          ...
          try {
            ...
            if (m_storeOutput.isSelected()) {
              ...
              if (associator instanceof weka_predictions.associations.AssociationRulesProducer) {
                // xmlRules = null;
                rulesList = null;
                try {
                  // xmlRules =
                  // ((weka.associations.XMLRulesProducer)associator).xmlRules();
                  rulesList = ((weka_predictions.associations.AssociationRulesProducer) associator)
                      .getAssociationRules();
                } catch (Exception ex) {
                }
              }
