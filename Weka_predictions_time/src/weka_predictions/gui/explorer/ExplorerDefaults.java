...
public class ExplorerDefaults
  ...
  public static Object getFilter() {
    return getObject("Filter", "", weka_predictions.filters.Filter.class);
  }
  ...
  public static Object getClassifier() {
    ...
    result = getObject(
		"Classifier", 
		weka_predictions.classifiers.rules.ZeroR.class.getName(), 
		weka_predictions.classifiers.Classifier.class);
    if (result == null)
      result = new weka_predictions.classifiers.rules.ZeroR();
  ...
  public static Object getClusterer() {
    ...
    result = getObject(
		"Clusterer", 
		weka_predictions.clusterers.EM.class.getName(), 
		weka_predictions.clusterers.Clusterer.class);
    if (result == null)
      result = new weka_predictions.clusterers.EM();
  ...
  public static Object getAssociator() {
    ...
    result = getObject(
		"Associator", 
		weka_predictions.associations.Apriori.class.getName(), 
		weka_predictions.associations.Associator.class);
    if (result == null)
      result = new weka_predictions.associations.Apriori();
  ...
  public static Object getASEvaluator() {
    ...
    result = getObject(
		"ASEvaluation", 
		weka_predictions.attributeSelection.CfsSubsetEval.class.getName(), 
		weka_predictions.attributeSelection.ASEvaluation.class);
    if (result == null)
      result = new weka_predictions.attributeSelection.CfsSubsetEval();
  ...
  public static Object getASSearch() {
    ...
    result = getObject(
		"ASSearch", 
		weka_predictions.attributeSelection.BestFirst.class.getName(), 
		weka_predictions.attributeSelection.ASSearch.class);
    if (result == null)
      result = new weka_predictions.attributeSelection.BestFirst();
