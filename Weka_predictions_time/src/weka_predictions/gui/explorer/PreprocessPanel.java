...
import weka_predictions.core.converters.AbstractFileLoader;
import weka_predictions.core.converters.AbstractFileSaver;
import weka_predictions.core.converters.ConverterUtils;
import weka_predictions.core.converters.Loader;
import weka_predictions.core.converters.SerializedInstancesLoader;
import weka_predictions.core.converters.URLSourcedLoader;
import weka_predictions.datagenerators.DataGenerator;
import weka_predictions.experiment.InstanceQuery;
import weka_predictions.filters.Filter;
import weka_predictions.filters.SupervisedFilter;
import weka_predictions.filters.unsupervised.attribute.Remove;
import weka_predictions.gui.AttributeSelectionPanel;
import weka_predictions.gui.AttributeSummaryPanel;
import weka_predictions.gui.AttributeVisualizationPanel;
import weka_predictions.gui.ConverterFileChooser;
import weka_predictions.gui.GenericObjectEditor;
import weka_predictions.gui.InstancesSummaryPanel;
...
import weka_predictions.gui.ViewerDialog;
...
import weka_predictions.gui.sql.SqlViewerDialog;
...
public class PreprocessPanel
  ...
  static {
     weka_predictions.core.WekaPackageManager.loadPackages(false);
  ...
  public PreprocessPanel() {
    ...
    m_FilterEditor.setClassType(weka_predictions.filters.Filter.class);
	...
	public void actionPerformed(ActionEvent ae) {
	  if (m_Instances != null) {
	    try {
	      final weka_predictions.gui.beans.AttributeSummarizer as = 
		new weka_predictions.gui.beans.AttributeSummarizer();
...
//	  m_RemoveButton.setEnabled(true);
  ...
  private void converterQuery(final File f) {
    ...
    try {
      convEd.setClassType(weka_predictions.core.converters.Loader.class);
      convEd.setValue(new weka_predictions.core.converters.CSVLoader());
