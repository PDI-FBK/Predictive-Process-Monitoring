...
import weka_predictions.attributeSelection.AttributeEvaluator;
import weka_predictions.attributeSelection.AttributeSelection;
import weka_predictions.attributeSelection.AttributeTransformer;
...
import weka_predictions.gui.visualize.MatrixPanel;
          ...
          public void propertyChange(PropertyChangeEvent e) {
            if (m_AttributeEvaluatorEditor.getValue() instanceof AttributeEvaluator) {
              ...
              if (m_AttributeSearchEditor.getValue() instanceof Ranker) {
                ...
                if (result == JOptionPane.YES_OPTION) {
                  m_AttributeSearchEditor
                      .setValue(new weka_predictions.attributeSelection.GreedyStepwise());
                } else {
                  // restore to what was there previously (if possible)
                  if (backup != null) {
                    m_AttributeEvaluatorEditor.setValue(backup);
          ...
          public void propertyChange(PropertyChangeEvent e) {
            if (m_AttributeSearchEditor.getValue() instanceof Ranker) {
              if (!(m_AttributeEvaluatorEditor.getValue() instanceof AttributeEvaluator)) {
                ...
                if (result == JOptionPane.YES_OPTION) {
                  m_AttributeEvaluatorEditor
                      .setValue(new weka_predictions.attributeSelection.InfoGainAttributeEval());
                } else {
                  // restore to what was there previously (if possible)
                  if (backup != null) {
              ...
              if (m_AttributeEvaluatorEditor.getValue() instanceof AttributeEvaluator) {
                ...
                if (result == JOptionPane.YES_OPTION) {
                  m_AttributeEvaluatorEditor
                      .setValue(new weka_predictions.attributeSelection.CfsSubsetEval());
                } else {
                  // restore to what was there previously (if possible)
                  if (backup != null) {
                    m_AttributeSearchEditor.setValue(backup);
    ...
    if (m_RunThread == null) {
      ...
      m_RunThread = new Thread() {
        ...
        public void run() {
          ...
          // 2. filter command
          weka_predictions.filters.supervised.attribute.AttributeSelection filter = new weka_predictions.filters.supervised.attribute.AttributeSelection();
          ...
          weka_predictions.classifiers.meta.AttributeSelectedClassifier cls = new weka_predictions.classifiers.meta.AttributeSelectedClassifier();
