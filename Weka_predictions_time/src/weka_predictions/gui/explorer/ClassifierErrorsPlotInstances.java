...
import weka_predictions.classifiers.evaluation.NumericPrediction;
...
import weka_predictions.gui.visualize.Plot2D;
  ...
  public void process(Instance toPredict, Classifier classifier, Evaluation eval) {
    ...
    try {
      ...
      if (classifier instanceof weka_predictions.classifiers.misc.InputMappedClassifier
        ...
        toPredict = ((weka_predictions.classifiers.misc.InputMappedClassifier) classifier)
            .constructMappedInstance(toPredict);
        mappedClass = ((weka_predictions.classifiers.misc.InputMappedClassifier) classifier)
            .getMappedClassIndex();
