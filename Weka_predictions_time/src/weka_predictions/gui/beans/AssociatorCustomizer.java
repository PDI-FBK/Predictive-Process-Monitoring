...
public class AssociatorCustomizer
  ...
  private weka_predictions.gui.beans.Associator m_dsAssociator;
  ...
  private weka_predictions.associations.Associator m_backup;
  ...
  public void setObject(Object object) {
    m_dsAssociator = (weka_predictions.gui.beans.Associator)object;
    //    System.err.println(Utils.joinOptions(((OptionHandler)m_dsClassifier.getClassifier()).getOptions()));
    try {
      m_backup = 
        (weka_predictions.associations.Associator)GenericObjectEditor.makeCopy(m_dsAssociator.getAssociator());
    } catch (Exception ex) {
      // ignore
    }
