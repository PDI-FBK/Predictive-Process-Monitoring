...
public class ClustererCustomizer
  ...
  private weka_predictions.gui.beans.Clusterer m_dsClusterer;
  ...
  private weka_predictions.clusterers.Clusterer m_backup;
  ...
  public void setObject(Object object) {
    m_dsClusterer = (weka_predictions.gui.beans.Clusterer)object;
    try {
      m_backup = 
        (weka_predictions.clusterers.Clusterer)GenericObjectEditor.makeCopy(m_dsClusterer.getClusterer());
    } catch (Exception ex) {
      // ignore
    }
