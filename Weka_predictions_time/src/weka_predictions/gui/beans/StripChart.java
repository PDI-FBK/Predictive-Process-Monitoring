...
import weka_predictions.gui.visualize.PrintableComponent;
...
public class StripChart
  ...
  private transient weka_predictions.gui.Logger m_log = null;
  ...
  private static String numToString(double num) {
    ...
    String numString = weka_predictions.core.Utils.doubleToString(num,
