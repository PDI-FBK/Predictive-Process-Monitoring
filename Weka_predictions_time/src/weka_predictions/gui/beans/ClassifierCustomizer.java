...
public class ClassifierCustomizer extends JPanel implements BeanCustomizer,
  ...
  private weka_predictions.gui.beans.Classifier m_dsClassifier;
  /*
  ...
  protected weka_predictions.classifiers.Classifier m_backup;
  ...
  private void checkOnClassifierType() {
    ...
    if (editedC instanceof weka_predictions.classifiers.UpdateableClassifier
  ...
  public void setObject(Object object) {
    m_dsClassifier = (weka_predictions.gui.beans.Classifier) object;
    // System.err.println(Utils.joinOptions(((OptionHandler)m_dsClassifier.getClassifier()).getOptions()));
    try {
      m_backup = (weka_predictions.classifiers.Classifier) GenericObjectEditor
