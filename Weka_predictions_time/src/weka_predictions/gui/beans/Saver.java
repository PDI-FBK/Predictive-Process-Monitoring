...
import weka_predictions.core.converters.DatabaseConverter;
import weka_predictions.core.converters.DatabaseSaver;
...
public class Saver extends AbstractDataSink implements WekaWrapper,
   ...
   * Saver
   */
  private weka_predictions.core.converters.Saver m_Saver = new ArffSaver();
  private weka_predictions.core.converters.Saver m_SaverTemplate = m_Saver;
  ...
  private weka_predictions.core.converters.Saver makeCopy() throws Exception {
    return (weka_predictions.core.converters.Saver) new SerializedObject(m_SaverTemplate)
        .getObject();
  }
   ...
   * @param saver a Saver
   */
  public void setSaverTemplate(weka_predictions.core.converters.Saver saver) {
   ...
   */
  public weka_predictions.core.converters.Saver getSaverTemplate() {
  ...
  public void setWrappedAlgorithm(Object algorithm) {
    if (!(algorithm instanceof weka_predictions.core.converters.Saver)) {
      throw new IllegalArgumentException(algorithm.getClass() + " : incorrect "
          + "type of algorithm (Loader)");
    }
    setSaverTemplate((weka_predictions.core.converters.Saver) algorithm);
  }
