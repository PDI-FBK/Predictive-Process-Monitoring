...
import weka_predictions.associations.Apriori;
import weka_predictions.associations.AssociationRules;
import weka_predictions.associations.AssociationRulesProducer;
...
public class Associator
  ...
  private weka_predictions.associations.Associator m_Associator = new Apriori();
   ...
   */
  public void setAssociator(weka_predictions.associations.Associator c) {
   ...
   */
  public weka_predictions.associations.Associator getAssociator() {
    return m_Associator;
  }
  ...
  public void setWrappedAlgorithm(Object algorithm) {
    ...
    if (!(algorithm instanceof weka_predictions.associations.Associator)) { 
      throw new IllegalArgumentException(algorithm.getClass()+" : incorrect "
					 +"type of algorithm (Associator)");
    }
    setAssociator((weka_predictions.associations.Associator)algorithm);
  }
...
//		    m_visual.setText("Building model...");
			...
			+ modelString;
		      ...
		      notifyTextListeners(nt);
                    ...
                    if (m_Associator instanceof weka_predictions.core.Drawable && 
			m_graphListeners.size() > 0) {
		      String grphString = 
			((weka_predictions.core.Drawable)m_Associator).graph();
                      int grphType = ((weka_predictions.core.Drawable)m_Associator).graphType();
  ...
  public boolean eventGeneratable(String eventName) {
	...
	if (!((EventConstraints)source).eventGeneratable("dataSet")) {
      ...
      if (eventName.compareTo("graph") == 0 &&
          !(m_Associator instanceof weka_predictions.core.Drawable)) {
        return false;
      }
