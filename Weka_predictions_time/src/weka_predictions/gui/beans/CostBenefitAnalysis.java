...
//      double totalInstances = 
  ...
  public static void main(String[] args) {
    try {
      ...
      weka_predictions.classifiers.evaluation.ThresholdCurve tc = 
        new weka_predictions.classifiers.evaluation.ThresholdCurve();
      weka_predictions.classifiers.evaluation.EvaluationUtils eu = 
        new weka_predictions.classifiers.evaluation.EvaluationUtils();
      //weka.classifiers.Classifier classifier = new weka.classifiers.functions.Logistic();
      weka_predictions.classifiers.Classifier classifier = new weka_predictions.classifiers.bayes.NaiveBayes();
