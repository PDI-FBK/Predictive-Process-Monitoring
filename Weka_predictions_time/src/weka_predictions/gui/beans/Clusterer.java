...
public class Clusterer
  ...
  private weka_predictions.clusterers.Clusterer m_Clusterer = new EM();
   ...
   */
  public void setClusterer(weka_predictions.clusterers.Clusterer c) {
   ...
   */
  public weka_predictions.clusterers.Clusterer getClusterer() {
    return m_Clusterer;
  }
  ...
  public void setWrappedAlgorithm(Object algorithm) 
    ...
    if (!(algorithm instanceof weka_predictions.clusterers.Clusterer)) { 
      throw new IllegalArgumentException(algorithm.getClass()+" : incorrect "
					 +"type of algorithm (Clusterer)");
    }
    setClusterer((weka_predictions.clusterers.Clusterer)algorithm);
  }
...
//		    m_visual.setText("Building clusters...");
		    ...
		    if (m_Clusterer instanceof weka_predictions.core.Drawable && 
			m_graphListeners.size() > 0) {
		      String grphString = 
			((weka_predictions.core.Drawable)m_Clusterer).graph();
                      int grphType = ((weka_predictions.core.Drawable)m_Clusterer).graphType();
  ...
  public void loadModel() {
    try {
      ...
      if (returnVal == JFileChooser.APPROVE_OPTION) {
        ...
        weka_predictions.clusterers.Clusterer temp = (weka_predictions.clusterers.Clusterer)is.readObject();
