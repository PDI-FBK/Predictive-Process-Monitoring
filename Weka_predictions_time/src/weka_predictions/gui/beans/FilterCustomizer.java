...
public class FilterCustomizer extends JPanel implements BeanCustomizer,
  ...
  public void setObject(Object object) {
    m_filter = (weka_predictions.gui.beans.Filter) object;
    try {
      m_backup = (weka_predictions.filters.Filter) GenericObjectEditor.makeCopy(m_filter
          .getFilter());
    } catch (Exception ex) {
      // ignore
    }
