...
import weka_predictions.filters.AllFilter;
import weka_predictions.filters.StreamableFilter;
...
public class Filter extends JPanel implements BeanCommon, Visible, WekaWrapper,
   ...
   * The filter to use.
   */
  private weka_predictions.filters.Filter m_Filter = new AllFilter();
   ...
   */
  public void setFilter(weka_predictions.filters.Filter c) {
  ...
  public weka_predictions.filters.Filter getFilter() {
    return m_Filter;
  }
  ...
  public void setWrappedAlgorithm(Object algorithm) {
    ...
    if (!(algorithm instanceof weka_predictions.filters.Filter)) {
      throw new IllegalArgumentException(algorithm.getClass() + " : incorrect "
          + "type of algorithm (Filter)");
    }
    setFilter((weka_predictions.filters.Filter) algorithm);
  }
            ...
            public void run() {
              try {
                if (m_trainingSet != null) {
                  ...
                  Instances filteredData = weka_predictions.filters.Filter.useFilter(
                      m_trainingSet, m_Filter);
                  // m_visual.setText(oldText);
                  m_visual.setStatic();
                  EventObject ne;
                  if (e instanceof TrainingSetEvent) {
                    ne = new TrainingSetEvent(weka_predictions.gui.beans.Filter.this,
                        filteredData);
                    ...
                    ne = new DataSetEvent(weka_predictions.gui.beans.Filter.this,
                        filteredData);
                  }
          ...
          public void run() {
            try {
              if (m_testingSet != null) {
                ...
                Instances filteredTest = weka_predictions.filters.Filter.useFilter(
                    m_testingSet, m_Filter);
                // m_visual.setText(oldText);
                m_visual.setStatic();
                TestSetEvent ne = new TestSetEvent(weka_predictions.gui.beans.Filter.this,
                    filteredTest);
