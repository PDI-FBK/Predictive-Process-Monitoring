...
public class SerializedModelSaver extends JPanel implements BeanCommon,
   ...
   */
  protected transient weka_predictions.gui.Logger m_logger = null;
  ...
  public void acceptClassifier(final BatchClassifierEvent ce) {
    ...
    if (ce.getClassifier() instanceof weka_predictions.classifiers.misc.InputMappedClassifier) {
      try {
        trainHeader = ((weka_predictions.classifiers.misc.InputMappedClassifier) ce
