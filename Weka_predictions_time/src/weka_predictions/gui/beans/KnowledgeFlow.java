  ...
  public static void startApp() {
    KnowledgeFlowApp.addStartupListener(new StartUpListener() {
        public void startUpComplete() {
          weka_predictions.gui.SplashWindow.disposeSplash();
        }
      });
                                        
    weka_predictions.gui.SplashWindow.splash(ClassLoader.
                                 getSystemResource("weka/gui/beans/icons/splash.jpg"));

    Thread nt = new Thread() {
        public void run() {
          weka_predictions.gui.SplashWindow.invokeMethod("weka.gui.beans.KnowledgeFlowApp", 
    ...
    public static void main(String[] args) {
      ...
      weka_predictions.gui.SplashWindow.splash(ClassLoader.
                                   getSystemResource("weka/gui/beans/icons/splash.jpg"));
      weka_predictions.gui.SplashWindow.invokeMain("weka.gui.beans.KnowledgeFlowApp", args);
      weka_predictions.gui.SplashWindow.disposeSplash();
    }
