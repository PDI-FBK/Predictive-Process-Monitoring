...
package weka_predictions.gui.beans.xml;
...
import weka_predictions.core.EnvironmentHandler;
import weka_predictions.core.converters.ConverterUtils;
import weka_predictions.core.xml.XMLBasicSerialization;
import weka_predictions.core.xml.XMLDocument;
import weka_predictions.gui.beans.BeanCommon;
import weka_predictions.gui.beans.BeanConnection;
import weka_predictions.gui.beans.BeanInstance;
import weka_predictions.gui.beans.BeanVisual;
import weka_predictions.gui.beans.MetaBean;
import weka_predictions.gui.beans.Visible;
...
public class XMLBeans 
  ...
  * (Instances and Connections are stored in a Vector and then serialized) */
  ...
  public void clear() throws Exception {
    ...
    // allow
    m_Properties.addAllowed(weka_predictions.gui.beans.BeanInstance.class, "x");
    m_Properties.addAllowed(weka_predictions.gui.beans.BeanInstance.class, "y");
    m_Properties.addAllowed(weka_predictions.gui.beans.BeanInstance.class, "bean");
    m_Properties.addAllowed(weka_predictions.gui.beans.Saver.class, "wrappedAlgorithm");
    m_Properties.addAllowed(weka_predictions.gui.beans.Loader.class, "wrappedAlgorithm");
    m_Properties.addAllowed(weka_predictions.gui.beans.Saver.class, "relationNameForFilename");
    if (getDataType() == DATATYPE_LAYOUT)
      m_Properties.addAllowed(weka_predictions.gui.beans.Loader.class, "beanContext");
    else
      m_Properties.addIgnored(weka_predictions.gui.beans.Loader.class, "beanContext");   // TODO: more classes???
    m_Properties.addAllowed(weka_predictions.gui.beans.Filter.class, "filter");
    m_Properties.addAllowed(weka_predictions.gui.beans.Associator.class, "associator");
    m_Properties.addAllowed(weka_predictions.gui.beans.Classifier.class, "wrappedAlgorithm");
    m_Properties.addAllowed(weka_predictions.gui.beans.Clusterer.class, "wrappedAlgorithm");
    m_Properties.addAllowed(weka_predictions.gui.beans.Classifier.class, "executionSlots");
    m_Properties.addAllowed(weka_predictions.gui.beans.Classifier.class, "blockOnLastFold");
    m_Properties.addAllowed(weka_predictions.gui.beans.Classifier.class, "resetIncrementalClassifier");
    m_Properties.addAllowed(weka_predictions.gui.beans.Classifier.class, "updateIncrementalClassifier");
    m_Properties.addAllowed(weka_predictions.gui.beans.Classifier.class, "loadClassifierFileName");

    m_Properties.addAllowed(weka_predictions.classifiers.Classifier.class, "debug");
    m_Properties.addAllowed(weka_predictions.classifiers.Classifier.class, "options");
    m_Properties.addAllowed(weka_predictions.associations.Associator.class, "options");
    m_Properties.addAllowed(weka_predictions.clusterers.Clusterer.class, "options");
    m_Properties.addAllowed(weka_predictions.filters.Filter.class, "options");
    m_Properties.addAllowed(weka_predictions.core.converters.Saver.class, "options");
    m_Properties.addAllowed(weka_predictions.core.converters.Loader.class, "options");
    
    m_Properties.addAllowed(weka_predictions.core.converters.DatabaseSaver.class, "options");
    m_Properties.addAllowed(weka_predictions.core.converters.DatabaseLoader.class, "options");
    m_Properties.addAllowed(weka_predictions.core.converters.TextDirectoryLoader.class, "options");

    // we assume that classes implementing SplitEvaluator also implement OptionHandler
    m_Properties.addAllowed(weka_predictions.experiment.SplitEvaluator.class, "options");
    // we assume that classes implementing ResultProducer also implement OptionHandler
    m_Properties.addAllowed(weka_predictions.experiment.ResultProducer.class, "options");
    ...
    m_CustomMethods.register(this, weka_predictions.gui.beans.BeanInstance.class, "BeanInstance");
    m_CustomMethods.register(this, weka_predictions.gui.beans.BeanConnection.class, "BeanConnection");
    m_CustomMethods.register(this, weka_predictions.gui.beans.BeanVisual.class, "BeanVisual");
    m_CustomMethods.register(this, weka_predictions.gui.beans.Saver.class, "BeanSaver");
    m_CustomMethods.register(this, weka_predictions.gui.beans.MetaBean.class, "MetaBean");
  ...
  public Object readBeanInstance(Element node) throws Exception {
    ...
    if (beaninst.getBean() instanceof weka_predictions.gui.beans.Visible) {
  ...
  public Element writeBeanLoader(Element parent, Object o, String name)
    ...
    Element                 node;
    weka_predictions.gui.beans.Loader   loader;
    ...
    loader = (weka_predictions.gui.beans.Loader) o;
  ...
  public Element writeBeanSaver(Element parent, Object o, String name)
    ...
    Element                 node;
    weka_predictions.gui.beans.Saver    saver;
    ...
    saver = (weka_predictions.gui.beans.Saver) o;
  ...
  public Element writeLoader(Element parent, Object o, String name)
    ...
    Element                       node;
    weka_predictions.core.converters.Loader   loader;
    File                          file;
    boolean                       known;
    ...
    loader = (weka_predictions.core.converters.Loader) o;
    node   = addElement(parent, name, loader.getClass().getName(), false);
    known  = true;
    file   = null;

    // file
    if (loader instanceof weka_predictions.core.converters.AbstractFileLoader)
      file = ((weka_predictions.core.converters.AbstractFileLoader) loader).retrieveFile();
    else
      known = false;
    ...
    if (loader instanceof weka_predictions.core.converters.FileSourcedConverter) {
      boolean relative = ((weka_predictions.core.converters.FileSourcedConverter)loader).getUseRelativePath();
    ...
    if ( (file == null) || (file.isDirectory()) ) {
      ...
      boolean notAbsolute = 
        (((weka_predictions.core.converters.AbstractFileLoader) loader).getUseRelativePath() ||
    ...
    if (loader instanceof weka_predictions.core.OptionHandler) {
      String[] opts = ((weka_predictions.core.OptionHandler)loader).getOptions();
  ...
  public Object readLoader(Element node) throws Exception {
    ...
    if (result instanceof weka_predictions.core.converters.FileSourcedConverter) {
      ((weka_predictions.core.converters.FileSourcedConverter)result).setUseRelativePath(relative);
    }
    ...
    if (file != null) {
      ...
      if (containsEnv || fl.exists() || 
        ...
        ((weka_predictions.core.converters.AbstractFileLoader) result).setSource(new File(file));
      } else {
  ...
  public Element writeSaver(Element parent, Object o, String name)
    ...
    Element                     node;
    weka_predictions.core.converters.Saver  saver;
    File                        file;
    String			prefix;
    String			dir;
    boolean                     known;
    ...
    saver  = (weka_predictions.core.converters.Saver) o;
    node   = addElement(parent, name, saver.getClass().getName(), false);
    known  = true;
    file   = null;
    prefix = "";
    ...
    // file
    if (saver instanceof weka_predictions.core.converters.AbstractFileSaver) {
      file   = ((weka_predictions.core.converters.AbstractFileSaver) saver).retrieveFile();
      prefix = ((weka_predictions.core.converters.AbstractFileSaver) saver).filePrefix();
      dir    = ((weka_predictions.core.converters.AbstractFileSaver) saver).retrieveDir();
      // Replace any windows file separators with forward slashes (Java under windows can
      // read paths with forward slashes (apparantly)
      dir = dir.replace('\\', '/');
    }
    ...
    Boolean relativeB = null;
    if (saver instanceof weka_predictions.core.converters.FileSourcedConverter) {
      boolean relative = ((weka_predictions.core.converters.FileSourcedConverter)saver).getUseRelativePath();
      relativeB = new Boolean(relative);
    }
...
/*    }
    ...
    if (saver instanceof weka_predictions.core.OptionHandler) {
      String[] opts = ((weka_predictions.core.OptionHandler)saver).getOptions();
      invokeWriteToXML(node, opts, VAL_OPTIONS);
    }
  ...
  public Object readSaver(Element node) throws Exception {
    ...
    if ( (dir != null) && (prefix != null) ) {
      ((weka_predictions.core.converters.AbstractFileSaver) result).setDir(dir);
      ((weka_predictions.core.converters.AbstractFileSaver) result).setFilePrefix(prefix);
    }
