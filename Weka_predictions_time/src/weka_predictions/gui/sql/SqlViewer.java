...
package weka_predictions.gui.sql;
...
import weka_predictions.gui.sql.event.ConnectionEvent;
import weka_predictions.gui.sql.event.ConnectionListener;
import weka_predictions.gui.sql.event.HistoryChangedEvent;
import weka_predictions.gui.sql.event.HistoryChangedListener;
import weka_predictions.gui.sql.event.QueryExecuteEvent;
import weka_predictions.gui.sql.event.QueryExecuteListener;
import weka_predictions.gui.sql.event.ResultChangedEvent;
import weka_predictions.gui.sql.event.ResultChangedListener;
