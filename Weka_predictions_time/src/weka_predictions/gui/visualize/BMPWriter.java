...
package weka_predictions.gui.visualize;
...
public class BMPWriter
  ...
  public static void main(String[] args) throws Exception {
    ...
    weka_predictions.gui.treevisualizer.TreeBuild builder = new weka_predictions.gui.treevisualizer.TreeBuild();
    weka_predictions.gui.treevisualizer.NodePlace arrange = new weka_predictions.gui.treevisualizer.PlaceNode2();
    weka_predictions.gui.treevisualizer.Node top = builder.create(new java.io.StringReader("digraph atree { top [label=\"the top\"] a [label=\"the first node\"] b [label=\"the second nodes\"] c [label=\"comes off of first\"] top->a top->b b->c }"));
    weka_predictions.gui.treevisualizer.TreeVisualizer tv = new weka_predictions.gui.treevisualizer.TreeVisualizer(null, top, arrange);
    tv.setSize(800 ,600);
